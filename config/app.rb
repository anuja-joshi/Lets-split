...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'lets-split-app.com'
  config.app_name = 'Lets_split_app'
  config.mailer.from = 'Lets_split_app <no-reply@lets-split-app.com>'
  ...
  #
  config.app_secret = 'ig2rzAdeGk809-goe1W4KaIc7dRMO6LfVgDpdExszReTDKmhrVBkoDR5rdh9U-udwBc'
